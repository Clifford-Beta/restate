                                        ...
                                        <div class="row p-b-15  ">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="propertyname" type="text" class="form-control" placeholder="Enter property name ...">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="propertyprice" type="text" class="form-control" placeholder="Shs.">
                                                </div> 
                                                <div class="form-group">
